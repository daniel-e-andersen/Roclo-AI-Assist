...
def reset_and_create_exact_history():
    ...
    # daniel-e-andersen: 160 commits (including initial)
    # Others: 452 commits distributed among remaining contributors
    
    daniel_remaining = 159  # 160 - 1 (initial commit)
    other_commits = 452
    
    # Distribute other commits
    other_distribution = {
        1: 120,  # Daniel Chalef
        2: 100,  # Pavlo Paliychuk  
        3: 70,   # Gal Shubeli
    ...
    print(f"\nCompleted! Created exactly 612 commits.")
